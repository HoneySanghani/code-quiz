...
let startEl = document.querySelector("#start-quiz");
...
displayMainScreen();
/*display main screen of quiz */
function displayMainScreen() {
  let welcomeScreen = document.createElement("h1");
  welcomeScreen.textContent = "Start The Quiz";
  ...
  startEl.appendChild(welcomeScreen);
  startEl.appendChild(descriptionScreen);
